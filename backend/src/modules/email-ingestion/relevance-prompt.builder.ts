...
export function buildSharedIngestRelevancePrompt(
  ...
  return [
    ...
    '- Calendar invitations, meeting updates, and event RSVPs when the mailbox is invited or needs to attend/respond',
    '- Meeting threads with a real human question or negotiation in the body',
    ...
    '- Mass newsletters, digests, marketing, flash sales, “webinar recording”, unsubscribable promo, Gmail Promotions-style offers',
    '- Third-party calendar noise with no invite for this mailbox (e.g. someone else’s RSVP-only notice with no action for this user)',
