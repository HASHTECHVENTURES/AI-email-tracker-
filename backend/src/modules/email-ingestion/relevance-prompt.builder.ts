...
export function buildSharedIngestRelevancePrompt(
  ...
  return [
    ...
    '- Meeting threads with a real human question or negotiation in the body (not machine-only calendar traffic)',
    ...
    '- Calendar system mail: invitations, updates, cancellations, and RSVP notices (Accepted:/Declined:/Tentative:, “has accepted your invitation”, Google Calendar / Outlook calendar senders) — no human reply expected',
